...
import javax.swing.*;
public class DepartEmployer extends JFrame implements ActionListener{
	private JPanel monPanel ;
	private JLabel lblMessage;
	private JTextField jtfNom;
	private JButton btnValider;
	private JButton btnRetour;
	public DepartEmployer (){
		this.setTitle("ZOO");
		...
		monPanel = new JPanel () ;
		lblMessage = new JLabel ("quelle est le nom de l'employer qui part ?");
	...
	public void actionPerformed ( ActionEvent evenement ) {
		if ( evenement.getSource() == btnValider) {
			System.out.println("l'employer est parti");
		}
