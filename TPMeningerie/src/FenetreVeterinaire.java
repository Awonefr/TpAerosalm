...
import javax.swing.*;
public class FenetreVeterinaire extends JFrame implements ActionListener{
	private JPanel monPanel ;
	private JLabel lblMessage;
	private JButton btnAjouterunAnimal;
	private JButton btnDepartAnimal;
	private JButton btnRetour;
	public FenetreVeterinaire (){
		this.setTitle("ZOO");
		...
		monPanel = new JPanel () ;
		lblMessage = new JLabel ("Bonjour vétérinaire que voullez vous faire ?");
